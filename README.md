            ...
            - task: PowerShell@2
              ...
              inputs:
                ...
                script: |
                  ...
                  Write-Host ""
                  if ($rows) { $rows | Sort-Object Action, Setting | Format-Table -AutoSize Action, Setting, @{Name='ExistingValue';Expression={$_.OldValue}}, NewValue | Out-String -Width 4096 | Write-Host }
