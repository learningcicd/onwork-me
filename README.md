...
variables:
  ...
  - name: nonprodPoolName
    value: "infra-pf-adopl-core-01-centralus-nprod"
  - name: prodPoolName
    value: "infra-pf-adopl-core-01-centralus-prod"
    ...
    - stage: deploy_stage_${{ replace(env, '-', '_') }}
      ...
      jobs:
        ...
        - job: prepJob
          ...
          pool: { name: $(nonprodPoolName), demands: azureps }
  ...
  - stage: QEFinalApproval
    ...
    jobs:
      ...
      - job: prepProdJob
        ...
        pool: { name: $(prodPoolName), demands: azureps }
